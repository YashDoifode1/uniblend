...
<body>
    ...
    <center><div class="user-info-container">
       ...
       <?php if (!empty($userData['profile_image'])) {
        ...
        <a href="<?php echo APP_URL; ?>user/users.php" style="padding: 10px;background-color: red; color: #fff; border: none; border-radius: 5px; cursor: pointer; margin-top: 10px;"> Users Page  </a>'
    ...
    if ($postResult->num_rows > 0) {
        while ($post = $postResult->fetch_assoc()) {
            ...
            echo '<a href="' . APP_URL .'action/single.php?id=' . $post["id"] . '"  style="padding: 10px;background-color: green; color: #fff; border: none; border-radius: 5px; cursor: pointer; margin-top: 10px;"> View </a>';
