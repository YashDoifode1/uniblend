...
if(isset($_SESSION['username'])) {
    ...
    $userQuery = "SELECT * FROM admin WHERE name = '$username'";
...
<body>
    <br>
    <h1>Welcome to your Profile, <span><?php echo $userData['name']; ?><span></h1><br>
    ...
    <center><div class="user-info-container">
       ...
       <?php if (!empty($userData['profile_image'])) {
        ...
        <p>Username: <span id='green'><?php echo $userData['name']; ?></span></p>
    ...
    if ($postResult->num_rows > 0) {
        while ($post = $postResult->fetch_assoc()) {
            ...
            echo '<img src="uploads/' . $post['image'] . '" alt="Profile Image">';
